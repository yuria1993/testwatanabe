        ...
        <div class="border-4 border-black m-3 p-3">
          ...
          <div class="flex">
            ...
            <div class="flex-1 w-32">
              ...
              @if($contents['gender']==='1')男性
              @endif
              @if($contents['gender']==='2')女性
              @endif
            </div>
          </div>
          ...
          <div class="flex justify-center py-3">
            <button type="submit" name="keyword" class="text-center  bg-black border-4 border-black text-white rounded-md">検索
            </button>
          </div>
          ...
          <div class="flex justify-center py-3">
            <div class="pb-3">
              <button type="submit" a href="{{route('system')}}" value="back" name="back" class="border-b-2 border-gray-600">リセット
              </button>
            </div>
          </div>
        </div>

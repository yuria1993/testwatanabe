            ...
            <div class="flex justify-center">
                <div class="py-12">
                    ...
                    <form method="post" class="h-adr" action="{{route('confirm')}}">
                        ...
                        {{--名前--}}
                        <p class="py-3">お名前</p><input type="text" name="family-name"
                        ...
                        {{--性別--}}
                        <p class="py-3">性別</p><input type="radio" name="gender"
                                                       value="1" {{ old('gender', "1")  === "1" ? "checked" : '' }}>男性
                        <input type="radio" name="gender" value="2" {{ old('gender')  === "2" ? 'checked' : '' }}>女性


                        {{--メールアドレス--}}
                        <p class="py-3">メールアドレス</p><input type="email" class="w-full" value="{{old('email', '')}}"
                        ...
                        {{--郵便番号--}}
                        <p class="py-3">郵便番号</p>〒<input type="text" id="input-postcode" class="w-full p-postal-code" size="8"
                                                            maxlength="8" name="postcode"
                                                            value="{{old('postcode', '')}}" placeholder="例)123-4567">
                        @if($errors->has('postcode'))
                            <p class="text-red-500">{{ $errors->first('postcode') }}</p>
                        @endif

                        {{--住所--}}
                        <p class="py-3">住所</p><input type="text"
                        ...
                        {{--建物名--}}
                        <p class="py-3">建物名</p><input type="text" class="w-full" name="building"
                                                         value="{{old('building_name', '')}}"
                                                         placeholder="例)千駄ヶ谷マンション101">

                        {{--ご意見--}}
                        <p class="py-3">ご意見</p><textarea name="opinion"
                        ...
                        <div class="flex justify-center py-3">
                            <button type="submit"
                                    class="text-center  bg-black border-4 border-black text-white rounded-md">確認
                            </button>
                        </div>
